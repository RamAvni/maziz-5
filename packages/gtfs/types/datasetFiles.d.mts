...
interface AgencyFile {
  fileName: "agency.txt";
  agencyId: FieldTypes["ID"];
  agencyName: FieldTypes["Text"];
  agencyUrl: FieldTypes["URL"];
  agencyTimezone: FieldTypes["Timezone"];
  agencyLang: FieldTypes["LanguageCode"];
  agencyPhone: FieldTypes["PhoneNumber"];
  agencyFareUrl: FieldTypes["URL"];
  agencyEmail: FieldTypes["Email"];
  cemvSupport: FieldTypes["Enum"];
}
